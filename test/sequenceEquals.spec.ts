...
describe("sequenceEquals() and sequenceEqualsAsync()", () => {
  collectorTest(sequenceEquals<number>([]), sequenceEqualsAsync<number>([]), [
    {
      input: [],
      result: true,
    },
  ...
  collectorTest(sequenceEquals([1, 2, 3]), sequenceEqualsAsync([1, 2, 3]), [
    {
      input: [],
      result: false,
    },
  ...
  collectorTest(sequenceEquals(input), sequenceEqualsAsync(input), [
    {
      input: [],
      result: false,
    },
